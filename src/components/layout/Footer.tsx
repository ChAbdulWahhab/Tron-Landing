    ...
    <footer className="w-full max-w-6xl mx-auto flex flex-col gap-12 py-16 px-8 border border-white/[0.05] rounded-[2.5rem] bg-white/[0.02] backdrop-blur-xl opacity-90 hover:opacity-100 transition-all duration-700 mb-12 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.5)]">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-6">
          <div className="text-lg font-bold uppercase tracking-[0.4em] text-white">TRON SUITE</div>
          ...
          <a href="mailto:ch.abdul.wahhab@proton.me" className="text-xs text-teal-400 hover:text-teal-300 transition-colors mt-2 font-medium">
            ch.abdul.wahhab@proton.me
          </a>
        </div>

        {/* Links */}
        <div className="flex flex-col gap-6">
          <div className="text-xs font-bold uppercase tracking-[0.2em] text-white/70">Product</div>
          <div className="flex flex-col gap-3 text-sm font-medium tracking-[0.05em] text-white/40">
            ...
            <a href="https://github.com/ChAbdulWahhab/Tron-Landing/issues" target="_blank" rel="noreferrer" className="hover:text-teal-400 transition-colors">Report a Bug</a>
          </div>
        </div>

        {/* Legal */}
        <div className="flex flex-col gap-6">
          <div className="text-xs font-bold uppercase tracking-[0.2em] text-white/70">Legal</div>
          <div className="flex flex-col gap-3 text-sm font-medium tracking-[0.05em] text-white/40">
        ...
        {/* Version */}
        <div className="flex flex-col gap-6">
          <div className="text-xs font-bold uppercase tracking-[0.2em] text-white/70">Status</div>
          <div className="flex flex-col gap-3 text-sm font-medium tracking-[0.05em] text-white/40">
            <div className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-teal-500 shadow-[0_0_10px_rgba(20,184,166,0.5)]"></span>
              <span>Version 2.0.0-x64</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-teal-500 shadow-[0_0_10px_rgba(20,184,166,0.5)]"></span>
